...
let rootFolder = window.location.pathname;
let split = rootFolder.split("/");
let folder = split[1];
		...
		1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e
			? (t("#dark-mode-switch").prop("checked", !1),
			  ...
			  t("#bootstrap-style").attr(
					"href",
					url + "Qovex_v1.0.0/Admin/Vertical/dist/assets/css/bootstrap.min.css"
			  ),
			  t("#app-style").attr(
					"href",
					url + "Qovex_v1.0.0/Admin/Vertical/dist/assets/css/app.min.css"
			  ),
			...
			? (t("#light-mode-switch").prop("checked", !1),
			  ...
			  t("#bootstrap-style").attr(
					"href",
					url +
						"Qovex_v1.0.0/Admin/Vertical/dist//assets/css/bootstrap-dark.min.css"
			  ),
			  t("#app-style").attr(
					"href",
					url + "Qovex_v1.0.0/Admin/Vertical/dist/assets/css/app-dark.min.css"
			  ),
			...
			: 1 == t("#rtl-mode-switch").prop("checked") &&
			  ...
			  t("#app-style").attr(
					"href",
					url + "Qovex_v1.0.0/Admin/Vertical/dist/assets/css/app-rtl.min.css"
			  ),
